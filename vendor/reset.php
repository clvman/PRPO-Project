...
else die('<script>window.alert("Invalid link or Password already changed ");window.location.href = "login.php";</script>');
...
{
$q="update users set password='".md5($_POST['password'])."' where email='".$_SESSION['email']."'";
$r=mysqli_query($con,$q);
if($r)mysqli_query($con,"update tokens set used=1 where token='".$token."'");
echo '<script>
          ...
          <div class="kt-login-v1__body">
            ...
            <div class="kt-login-v1__section">
              <div class="kt-login-v1__info">
                <h3 class="kt-login-v1__intro">Procurement System</h3>
                <p>Vendor Portal</p>
              </div>
            </div>
            ...
            <div class="kt-login-v1__wrapper">
              <div class="kt-login-v1__container">
                ...
                <!--begin::Form-->
                                  ...
                                  <form  class="kt-login-v1__form kt-form"  method="POST">
                      ...
                      <input required class="form-control" type="password" id="password" placeholder="New Password" name="password" >
                      </div>
                      ...
                      <input required class="form-control" type="password" id="confirm_password" placeholder="Confirm Password" name="confirm_password" >
                      </div>
