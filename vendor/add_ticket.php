...
date_default_timezone_set('Asia/Amman'); 
   ...
   if(isset($_POST['ticket_id'])) {
    ...
    //$requester= $_SESSION['NCE_TT_vendor'];
...
if(move_uploaded_file($_FILES['attachment']['tmp_name'], $target)) {
  ...
  $sql .= "( '{$ticket_id}' , '{$domain}','{$Service_Impact}','{$Owner}','{$screen}','{$Scenario}', '{$Description}','{$_FILES['attachment']['name']}' ,'{$Status}','{$Severity}',now());";
...
pclose(popen("start /B C:/xampp/php/php.exe C:/xampp/htdocs/NCE/vendor/add_ticket_email.php","w"));       
...
?>								
									...
									<div class="form-group row form-group-marginless kt-margin-t-20">
													...
													<div class="col-lg-3">
											<input required name="Owner" readonly  type="text" class="form-control" value="<?php echo $_SESSION['NCE_TT_vendor'] ?>" >
