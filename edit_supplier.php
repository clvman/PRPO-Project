...
if($result){   
            echo "<script>alert('Done');window.location = 'all_suppliers.php';</script>" ;
              ...
              <!--begin::Dashboard 2-->
                    <div class="kt-portlet__head">
                      <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">Edit Supplier</h3>
                      </div>
                    </div>
              <!--begin::Row-->
...
<br>
  ...
  <div class="form-group">
    ...
    <input required type="text" class="form-control "  name="supplier_name" value="<?php echo  $supplier_name; ?>" ></input>   

  </div>

  <div class="form-group">
    <label for="email">Country</label>
    <input optional type="text" class="form-control "  name="country" value="<?php echo  $country; ?>" ></input>   
  ...
  <div class="form-group">
    ...
    <input optional type="text" class="form-control "  name="telephone_number" value="<?php echo  $telephone_number; ?>" ></input>   

  </div>

  <div class="form-group">
    <label for="email">Fax</label>
    <input optional type="text" class="form-control "  name="fax" value="<?php echo  $fax; ?>" ></input>   
    ...
    <input optional type="text" class="form-control "  name="address" value="<?php echo  $address; ?>" ></input>   
    ...
    <input optional type="text" class="form-control "  name="email" value="<?php echo  $email; ?>" ></input>   
