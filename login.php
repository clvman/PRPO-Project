					...
					<div class="kt-login-v1__body">
						...
						<div class="kt-login-v1__wrapper">
							<div class="kt-login-v1__container">
								...
								<!--begin::Form-->
								<form class="kt-login-v1__form kt-form" action="login_validation.php" method="POST">
									<div class="form-group">
										<input required class="form-control" type="text" placeholder="username" name="username" autocomplete="off">
									</div>
									<div class="form-group">
										<input required="" class="form-control" type="password" placeholder="password" name="password" autocomplete="off">
									</div>
									<div class="kt-login-v1__actions">
										<a href="forgotpassword.php" class="kt-login-v1__forgot">
											Forgot Password ?
										</a>
