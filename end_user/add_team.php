...
if (isset($_POST['team_name'])){
 ...
 $query_0 = "SELECT * FROM `teams` WHERE (team_name='$team_name'and team_email='$team_email' and role='$role')";
 $result_0 = mysqli_query($con,$query_0) or die(mysql_error());
  if(mysqli_num_rows($result_0) > 0){
        ...
        $query = "INSERT into `teams` (team_email, team_name,role)VALUES ('$team_email','$team_name','$role')";
		//echo $query ;
