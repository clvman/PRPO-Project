...
pclose(popen("start /B C:/xampp/php/php.exe C:/xampp/htdocs/NCE/end_user/add_ticket_email.php","w"));       
...
?>								
									...
									<div class="form-group row form-group-marginless kt-margin-t-20">
													...
													<div class="col-lg-3">
											<input required name="Owner" readonly  type="text" class="form-control" value="<?php echo $_SESSION['NCE_TT_end_user'] ?>" >
