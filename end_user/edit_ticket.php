...
<?php 
      ...
      $editor = $_SESSION['NCE_TT_end_user'];
      $commenter = $_SESSION['NCE_TT_end_user'];
...
$Owner= $_SESSION['NCE_TT_end_user'];
...
pclose(popen("start /B C:/xampp/php/php.exe C:/xampp/htdocs/NCE/end_user/update_ticket_email.php","w"));
...
pclose(popen("start /B C:/xampp/php/php.exe C:/xampp/htdocs/NCE/end_user/resolve_ticket_email.php","w"));
...
pclose(popen("start /B C:/xampp/php/php.exe C:/xampp/htdocs/NCE/end_user/remark_email.php","w"));
