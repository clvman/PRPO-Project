									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Departments</h3>
											</div>
										</div>
...
$(document).ready(function(){
 ...
 var dataTable = $('#user_data').DataTable({
  ...
  "order":[],
  "ajax":{
   url:"datatables_crud/Departments/fetch.php",
   type:"POST"
  },
...
"columnDefs":[
 ...
 $(document).on('submit', '#user_form', function(event){
  ...
  var Department_head_email = $('#Department_head_email').val();
   ...
   $.ajax({
    url:"datatables_crud/Departments/insert.php",
    method:'POST',
 ...
 $(document).on('click', '.update', function(){
  ...
  $.ajax({
   url:"datatables_crud/Departments/fetch_single.php",
   method:"POST",
 ...
 $(document).on('click', '.delete', function(){
  ...
  {
   $.ajax({
    url:"datatables_crud/Departments/delete.php",
    method:"POST",
    data:{department_id:department_id},
    success:function(data)
    {
