...
$q="INSERT INTO `token`( `token`, `email`, `used`) VALUES ('".$token."','".$email."',0)";
echo $q;
...
$subject = "Forgot Password on Procurement System";
...
<body>
<p>Click on the given link to reset your password <a href="'.$uri.'/NCE/reset.php?token='.$token.'">Reset Password</a></p>
...
?>
  <script>
  window.alert("We have sent the password reset link to your  email!");
  window.location.href = "login.php";
</script>
...
if(isset($_GET['email'])){mailresetlink($email,$token);}
                ...
                <form class="kt-login-v1__form kt-form" action="forgotpassword.php">
                  <div class="form-group">
                    <input required class="form-control" type="email" placeholder="Enter Your Email..." name="email" >
                  </div>
